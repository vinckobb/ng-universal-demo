...
@Component(
{
    selector: "grid-legacy-sample",
    templateUrl: "gridLegacySample.component.html",
    providers: [GridDataService],
    animations: [flyInOutTrigger]
})
@ComponentRedirectRoute('')
@ComponentRoute({path: 'grid-legacy', canActivate: [AuthGuard]})
@Authorize("gridLegacySample-page")
export class GridLegacySampleComponent extends BaseAnimatedComponent
{
    //######################### public properties #########################
